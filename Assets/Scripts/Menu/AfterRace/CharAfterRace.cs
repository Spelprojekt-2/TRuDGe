...
public class CharAfterRace : MonoBehaviour
{
    ...
    [SerializeField] private GameObject[] charWin;

    public void Display2DCharacter(string racen)
    {
        switch (racen)
        {
            case "Lars-Göran": charWin[0].SetActive(true); break;
            case "The Brass Beast": charWin[1].SetActive(true); break;
            case "Capôw": charWin[2].SetActive(true); break;
            case "King Napoleon III": charWin[3].SetActive(true); break;
